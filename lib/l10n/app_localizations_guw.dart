...
/// The translations for Gun (`guw`).
class AppLocalizationsGuw extends AppLocalizations {
  AppLocalizationsGuw([String locale = 'guw']) : super(locale);

  @override
  String get navAccueil => 'Xwé';
  ...
  @override
  String get homeChurchTagline => 'Agun Agun sisen wiwé olon ton ton lè';
  ...
  String get profileShareText =>
      'Découvrez ilemO, l\'application qui centralise les paroisses de l\'Agun sisen wiwé olon ton au Bénin !';
  ...
  String get aboutDialogDescription =>
      'Application de centralisation des paroisses de l\'Agun sisen wiwé olon ton.';
  ...
  String get aideAccueilDesc =>
      'L\'écran d\'accueil affiche l\'emblème de l\'Agun sisen wiwé olon ton, un aperçu en direct du nombre de paroisses référencées, ainsi qu\'un carrousel de présentation. Vous y retrouvez aussi une carte \"En fête ce mois\" qui met en avant les paroisses célébrant leur fête ce mois-ci, et un aperçu des dernières actualités.';
  ...
  String get privacySection1Body =>
      'ilemO est une application indépendante créée pour centraliser les informations des paroisses de l\'Agun sisen wiwé olon ton au Bénin, avec une vocation à s\'étendre à d\'autres pays africains. Elle est développée et maintenue par un développeur indépendant, en dehors de toute structure administrative officielle de l\'église.';
